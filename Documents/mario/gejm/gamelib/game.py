...
class Game(object):
    ...
    def intro_level(self):
        ...
        self.draw_stats()
        ren = self.font.render("Svet 1-%d" % self.lvl, 1, (255, 255, 255))
        self.screen.blit(ren, (320-ren.get_width()/2, 230))
        ren = self.font.render("Zivoty x%d" % self.lives, 1, (255, 255, 255))
    ...
    def show_death(self):
        ren = self.font.render("CHCIPNUL SI CYPE", 1, (255, 255, 255))
    ...
    def gameover_screen(self):
        ...
        cutscene(self.screen, ["Zemrel si"])
        self.end()
...
#_______________________________________________________________________
    ...
    def draw_stats(self):
        ...
        ren = self.font.render("Nej:%05d" % self.highscore, 1, (255, 255, 255))
        self.screen.blit(ren, (260-ren.get_width(), 38))
        ren1 = self.font.render("Cas: %d" % self.time, 1, (255, 255, 255))
        ren2 = self.font.render("Cas: %d" % self.time, 1, Color("#ffffff"))
